...
gdjs.CreditsCode.GDBlackNoteeObjects1= [];
gdjs.CreditsCode.GDBlackNoteeObjects2= [];
gdjs.CreditsCode.GDblacksplashObjects1= [];
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(20313628);
}
}
if (isConditionTrue_0) {
...
gdjs.CreditsCode.GDBlackNoteeObjects1.length = 0;
gdjs.CreditsCode.GDBlackNoteeObjects2.length = 0;
gdjs.CreditsCode.GDblacksplashObjects1.length = 0;
