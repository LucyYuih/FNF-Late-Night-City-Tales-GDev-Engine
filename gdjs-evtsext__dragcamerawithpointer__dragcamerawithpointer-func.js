...
{gdjs.evtTools.camera.setCameraX(runtimeScene, gdjs.evtTools.camera.getCameraX(runtimeScene, "" + eventsFunctionContext.getArgument("CamLayer"), (Number(eventsFunctionContext.getArgument("CamNumber")) || 0)) - (gdjs.evtTools.variable.getVariableNumber(runtimeScene.getScene().getVariables().get("__DragCameraWithPointer").getChild("scrollDistanceX"))), "" + eventsFunctionContext.getArgument("CamLayer"), (Number(eventsFunctionContext.getArgument("CamNumber")) || 0));
}
}
...
if (isConditionTrue_0) {
{gdjs.evtTools.camera.setCameraY(runtimeScene, gdjs.evtTools.camera.getCameraY(runtimeScene, "" + eventsFunctionContext.getArgument("CamLayer"), (Number(eventsFunctionContext.getArgument("CamNumber")) || 0)) - (gdjs.evtTools.variable.getVariableNumber(runtimeScene.getScene().getVariables().get("__DragCameraWithPointer").getChild("scrollDistanceY"))), "" + eventsFunctionContext.getArgument("CamLayer"), (Number(eventsFunctionContext.getArgument("CamNumber")) || 0));
}
}
...
let isConditionTrue_0 = false;
{
{runtimeScene.getScene().getVariables().get("__DragCameraWithPointer").getChild("scrollTargetX").setNumber(gdjs.evtTools.input.getCursorX(runtimeScene, "" + eventsFunctionContext.getArgument("CamLayer"), (Number(eventsFunctionContext.getArgument("CamNumber")) || 0)));
}
{runtimeScene.getScene().getVariables().get("__DragCameraWithPointer").getChild("scrollTargetY").setNumber(gdjs.evtTools.input.getCursorY(runtimeScene, "" + eventsFunctionContext.getArgument("CamLayer"), (Number(eventsFunctionContext.getArgument("CamNumber")) || 0)));
}
...
isConditionTrue_0 = false;
{
{isConditionTrue_1 = ("" + eventsFunctionContext.getArgument("Direction") == "horizontal");
}
...
{
{isConditionTrue_1 = ("" + eventsFunctionContext.getArgument("Direction") == "both");
}
if(isConditionTrue_1) {
    isConditionTrue_0 = true;
}
...
{
{isConditionTrue_1 = ("" + eventsFunctionContext.getArgument("Direction") == "");
}
if(isConditionTrue_1) {
    isConditionTrue_0 = true;
}
...
isConditionTrue_0 = false;
{
{isConditionTrue_1 = ("" + eventsFunctionContext.getArgument("Direction") == "vertical");
}
if(isConditionTrue_1) {
    isConditionTrue_0 = true;
}
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = eventsFunctionContext.getOnceTriggers().triggerOnce(18768988);
}
}
if (isConditionTrue_0) {
{runtimeScene.getScene().getVariables().get("__DragCameraWithPointer").getChild("scrollStartX").setNumber(gdjs.evtTools.input.getCursorX(runtimeScene, "" + eventsFunctionContext.getArgument("CamLayer"), (Number(eventsFunctionContext.getArgument("CamNumber")) || 0)));
}
{runtimeScene.getScene().getVariables().get("__DragCameraWithPointer").getChild("scrollStartY").setNumber(gdjs.evtTools.input.getCursorY(runtimeScene, "" + eventsFunctionContext.getArgument("CamLayer"), (Number(eventsFunctionContext.getArgument("CamNumber")) || 0)));
}
}
